...
public class SearchComm {
	...
	private static List<Integer> ids3=new ArrayList<Integer>();
	private static int ye=1;

	public static void setUserid(int userid) {
		SearchComm.userid = userid;
	}

	public static void setIds3(List<Integer> ids3) {
		SearchComm.ids3 = ids3;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SearchComm window = new SearchComm();
	 ...
	 * @throws Exception 
	 */
	public SearchComm() throws Exception {
		initialize();
	}
	...
	private void initialize() throws Exception {
		...
		String sql="select  c_id,m_id,f_id,c_x,c_length,c_date from Comment11 where c_id=?";
		s.setPreparedStatement(sql);
		
		Object[][] ob=new Object[ids3.size()][6];
		for (int i = 0; i < ids3.size(); i++) {
			s.getPs().setInt(1, ids3.get(i));
		...
		JLabel label_17 = new JLabel(ids3.size()+"");

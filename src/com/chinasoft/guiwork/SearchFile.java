...
public class SearchFile {
	...
	private static List<Integer> ids1=new ArrayList<Integer>();
	private static int ye=1;
	private JTextField textField_1;

	public static void setUserid(int userid) {
		SearchFile.userid = userid;
	}

	public static void setIds1(List<Integer> ids1) {
		SearchFile.ids1 = ids1;
	}
	 ...
	 * @throws Exception 
	 */
	public SearchFile() throws Exception {
		initialize();
	}
	...
	private void initialize() throws Exception {
		...
		String sql="select f_id,f_name,f_type,f_size,f_dwpoints,f_dwcount from FileInfo11 where f_id=?";
		s.setPreparedStatement(sql);
		
		Object[][] ob=new Object[ids1.size()][6];
		for (int i = 0; i < ids1.size(); i++) {
			s.getPs().setInt(1, ids1.get(i));
		...
		label_2.setFont(new Font("ËÎÌו", Font.BOLD, 12));
		...
		label_4.setFont(new Font("ËÎÌו", Font.BOLD, 12));
		label_4.setBounds(240, 126, 54, 15);
		panel.add(label_4);
		
		JLabel label_5 = new JLabel("\u5F53\u524D\u4F4D\u7F6E>\u641C\u7D22-\u6587\u4EF6");
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getClickCount()==2){
					String sid=(String) obj[table.rowAtPoint(e.getPoint())][0];
		...
		JLabel label_17 = new JLabel(ids1.size()+"");
